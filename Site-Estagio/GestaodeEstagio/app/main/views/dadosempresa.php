                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    if ($result > 0) {
                        foreach ($query as $value) {
                            ...
                            echo "<button type='submit' name='btn-excluir' value='" . htmlspecialchars($value['id']) . "' class='text-red-600 hover:text-red-800 bg-red-50 rounded-full p-2 transition-colors' title='Excluir empresa' aria-label='Excluir empresa'><i class='fas fa-trash'></i></button>";
                            echo "</form>";
                            echo "</div>";
                            echo "</td>";
                            echo "</tr>";
        ...
        <div class="md:hidden">
            ...
            if ($result > 0) {
                foreach ($query as $value) {
                    ...
                    echo "<form action='../controllers/Controller-Exclusoes.php' method='POST' style='display: inline;' onsubmit='return confirm(\"Tem certeza que deseja excluir esta empresa?\");'>";
                    echo "<input type='hidden' name='tipo' value='empresa'>";
                    echo "<button type='submit' name='btn-excluir' value='" . htmlspecialchars($value['id']) . "' class='action-button text-red-600 hover:text-red-800 bg-red-50' title='Excluir empresa' aria-label='Excluir empresa'><i class='fas fa-trash'></i></button>";
                    echo "</form>";
                    echo "</div>";
                    echo "</div>";
                }
